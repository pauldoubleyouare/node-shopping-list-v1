...
ShoppingList.create('salami', 10);

Recipes.create('ice cream', ['milk', 'sugar', 'heavy cream', 'salt', 'ice']);
Recipes.create('sorbet', ['fruit', 'sugar', 'ice', 'freezer']);
...
app.get('/', (req, res) => {
	res.send("<h1> shopping is cool </h1>");
});
